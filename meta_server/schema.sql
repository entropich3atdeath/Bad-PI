...
CREATE TABLE IF NOT EXISTS dimensions (
    ...
    programme_label  TEXT DEFAULT NULL          -- soft label: which programme this variable dim belongs to
);
...
VALUES
    -- 'core' dims define research programme boundaries (different values = rival programmes)
    -- 'variable' dims are tuned within each programme's protective belt
